...
|---:|---|---:|---:|---:|---|---|---|---|---|---|---|
| 1 | consistent | 135 | 13.248 | 0.726 | G1 | Ideas | NA | NA | NA | C | 维度一待定：consistent tense(G2)vs consistent argument(G1)；同组 2 consistency 口径〔沿用组 10〕〔concordance 判定：d1=G1-Ideas(33%)〕 |
...
| 8 | check | 101 | 6.242 | 0.560 | G1 | Development | A3 | NA | NA | C | 维度一待定：check your spelling(G2)vs check your logic(G1)；手册 A3 明示〔沿用组 2〕〔concordance 判定：d1=G1-Development(29%)〕 |
| 9 | paragraph | 1688 | 5.672 | 0.121 | G1 | Development | NA | NA | NA | C | 维度一待定：手册明示段落内部组织→G2、段落间安排→G1〔沿用组 10〕〔concordance 判定：d1=G1-Development(36%)〕 |
...
| 24 | level | 298 | 4.222 | 0.254 | G2 | Local Structure | NA | NA | NA | C | 维度一待定：sentence-level(G2)/paragraph-level(G1)/level of detail(G1-Dev)〔沿用组 1〕〔concordance 判定：d1=G2-Local Structure(94%)〕 |
| 25 | defensible | 53 | 4.043 | 0.630 | G1 | Ideas | A1 | NA | NA | M | 域固定于 claim/thesis；正向评价，但存在目标态框架风险〔沿用组 1〕 |
| 26 | vague | 126 | 3.846 | 0.382 | G2 | Wording | A2 | NA | NA | C | 维度一待定：与 unclear 同族，可指论证或用词〔沿用组 1〕〔concordance 判定：d1=G2-Wording〕 |

### B1 维度一 Feedback Focus

| 标签 | 词位数 | 占已定标签 | Freq_Tar 合计 | 占已定标签词次 | LR 均值 |
|---|---:|---:|---:|---:|---:|
| G1 | 7 | 53.8% | 2352 | 54.0% | 0.506 |
| G2 | 6 | 46.2% | 2007 | 46.0% | 0.337 |
| **已定标签合计** | **13** | **100.0%** | **4359** | **100.0%** | — |
| N/A（不计入分母） | 12 | — | — | — | — |
| PENDING（不计入分母） | 1 | — | — | — | — |
| 清单总数 | 26 | — | — | — | — |
...
| 主类 | 子类 | 词位数 | 占比 |
|---|---|---:|---:|
| G1 | Development | 4 | 30.8% |
| G1 | Ideas | 3 | 23.1% |
| G2 | Local Structure | 3 | 23.1% |
| G2 | Mechanics | 1 | 7.7% |
| G2 | Wording | 2 | 15.4% |
...
|---|---:|---:|---:|
| 现状（PENDING 不计入） | 7 | 6 | 53.8% |
| 1 个 PENDING 全归 G1（上界） | 8 | 6 | 57.1% |
| 1 个 PENDING 全归 G2（下界） | 7 | 7 | 50.0% |

### B9 concordance 待办清单

共 **1** 个词族需 concordance 判定（含 2 个低信度已定项）。
